// Acess DOM elements of the calculator
...
function evaluateExpression() {
    ...
    // Check if evalResult isNaN or infinite. It is is, return a space character ' '
...
function negate() {
    ...
    if (expression === '' && result !== '') {
        ...
        // Remove the negative the sign from the expression if its already negative
    }
